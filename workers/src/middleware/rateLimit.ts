...
export const LIMITS: Record<string, RateLimitConfig> = {
  ...
  // Direct messages and private-room membership
  'POST:/api/v1/chatrooms/dm': { points: 20, duration: 3600 }, // 20 per hour
  ...
  // Findings: confirmations mirror votes
  'POST:/api/v1/posts/*/confirm': { points: 20, duration: 60 },
  ...
  // Moderation: plenty for honest reviewing, not enough to carpet-bomb
  'POST:/api/v1/posts/*/report': { points: 30, duration: 3600 }, // 30 per hour
  'POST:/api/v1/moderation/cases/*/vote': { points: 60, duration: 3600 }, // 60 per hour
  ...
  'POST:/api/v1/requests/*/accept': { points: 20, duration: 3600 },
  'POST:/api/v1/requests/*/decline': { points: 20, duration: 3600 },
  'POST:/api/v1/requests/*/deliver': { points: 10, duration: 3600 },
  'POST:/api/v1/requests/*/close': { points: 20, duration: 3600 },
  'POST:/api/v1/requests/*/cancel': { points: 20, duration: 3600 },
